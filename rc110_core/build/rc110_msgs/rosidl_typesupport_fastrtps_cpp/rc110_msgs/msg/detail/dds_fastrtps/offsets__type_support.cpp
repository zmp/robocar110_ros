...
#include "rc110_msgs/msg/detail/offsets__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rc110_msgs::msg::Offsets & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rc110_msgs::msg::Offsets & ros_message)
{
  // Member: gyro
  cdr >> ros_message.gyro;
...
{
  auto typed_message =
    static_cast<const rc110_msgs::msg::Offsets *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rc110_msgs::msg::Offsets *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Offsets__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rc110_msgs::msg::Offsets *>(
...
{
  return max_serialized_size_Offsets(full_bounded, 0);
}

static message_type_support_callbacks_t _Offsets__callbacks = {
  "rc110_msgs::msg",
  "Offsets",
...
static rosidl_message_type_support_t _Offsets__handle = {
...
{
  return &rc110_msgs::msg::typesupport_fastrtps_cpp::_Offsets__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rc110_msgs, msg, Offsets)() {
  return &rc110_msgs::msg::typesupport_fastrtps_cpp::_Offsets__handle;
}
