...
#include "rc110_msgs/msg/detail/status__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const rc110_msgs::msg::Status *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rc110_msgs::msg::Status *>(
    untyped_ros_message);
...
{
  return &rc110_msgs::msg::typesupport_fastrtps_cpp::_Status__handle;
}
