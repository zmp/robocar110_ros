...
static const _SetInteger_Request_type_support_symbol_names_t _SetInteger_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rc110_msgs, srv, SetInteger_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rc110_msgs, srv, SetInteger_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rc110_msgs, srv, SetInteger_Request)() {
  return &::rc110_msgs::srv::rosidl_typesupport_c::SetInteger_Request_message_type_support_handle;
}
...
static const _SetInteger_Response_type_support_symbol_names_t _SetInteger_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rc110_msgs, srv, SetInteger_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rc110_msgs, srv, SetInteger_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_rc110_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rc110_msgs, srv, SetInteger_Response)() {
  return &::rc110_msgs::srv::rosidl_typesupport_c::SetInteger_Response_message_type_support_handle;
}
...
static const _SetInteger_type_support_symbol_names_t _SetInteger_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rc110_msgs, srv, SetInteger)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rc110_msgs, srv, SetInteger)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, rc110_msgs, srv, SetInteger)() {
  return &::rc110_msgs::srv::rosidl_typesupport_c::SetInteger_service_type_support_handle;
}
